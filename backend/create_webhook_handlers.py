...
def create_webhook_handlers():
    ...
    print(f"✅ Created webhook handlers: {webhook_file}")
    ...
    if "from api.webhooks import router as webhooks_router" in content:
        print("✅ Webhook router already included in main.py")
    else:
        ...
        print("✅ Updated main.py with webhook router")
...
def main():
    ...
    print("\n✅ Webhook handlers created successfully!")
    print("\n📝 Next steps:")
